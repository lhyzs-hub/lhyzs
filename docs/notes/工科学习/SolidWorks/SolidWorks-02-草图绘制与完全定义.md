...
> 上一篇：[SolidWorks-01-界面与基础操作](SolidWorks-01-界面与基础操作.md) · [SolidWorks-00-阿奇教程学习索引](SolidWorks-00-阿奇教程学习索引.md) · 下一篇：[SolidWorks-03-零件特征与设计树](SolidWorks-03-零件特征与设计树.md)
...
- 推荐在 `工具 → 自定义 → 键盘` 中将“构造几何线”设为 `Alt+C`：绘制前按下可切换构造线模式；选中已有线段后按下，可在普通实线与构造线之间切换。完整自定义方案见 [SolidWorks-07-快捷键与复习清单](SolidWorks-07-快捷键与复习清单.md#31)。
...
---
> ← 上一篇：[SolidWorks 01 界面与基础操作](SolidWorks-01-界面与基础操作.md) · 下一篇：[SolidWorks 03 零件特征与设计树](SolidWorks-03-零件特征与设计树.md) →
<!-- lhyzs-note-nav:end -->
